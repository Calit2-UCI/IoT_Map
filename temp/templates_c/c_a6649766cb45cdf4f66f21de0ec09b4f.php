...
$this->register_compiler("l", "tpl_compiler_l");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2015-08-31 00:21:35 Pacific Daylight Time */ ?>
...
" name="gid" class="middle"><?php echo $this->_vars['data']['gid'];  else: ?><input type="text" value="<?php echo $this->_vars['data']['gid']; ?>
" name="gid" class="middle"><?php endif; ?></div>
		</div>
		<div class="row">
			<div class="h"><?php echo l('field_name', 'field_editor', '', 'text', array()); ?>: </div>
			<div class="v">
				<input type="text" class="middle" value="<?php if ($this->_vars['validate_lang']):  echo $this->_vars['validate_lang'][$this->_vars['cur_lang']];  else:  echo $this->_vars['data']['name'];  endif; ?>" name="langs[<?php echo $this->_vars['cur_lang']; ?>
]">
