...
$this->register_function("js", "tpl_function_js");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2016-02-10 23:02:53 Pacific Standard Time */ ?>
...
application/modules/geomap/views/default/css/yandexv2.css" rel="stylesheet" type="text/css" />
	<script><?php echo '
		$(function() {
			loadScripts(
				[
					"';  echo tpl_function_js(array('file' => 'yandexmapsv2.js','module' => 'geomap','return' => 'path'), $this); echo '", 
...
" class="<?php echo $this->_vars['view_settings']['class']; ?>
 map_container">&nbsp;<?php echo l('loading', 'geomap', '', 'text', array()); ?></div>
	<?php if ($this->_vars['view_settings']['use_router']): ?>
