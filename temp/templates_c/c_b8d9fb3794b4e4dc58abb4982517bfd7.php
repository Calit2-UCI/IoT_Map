...
$this->register_compiler("l", "tpl_compiler_l");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2015-10-17 01:33:47 Pacific Daylight Time */ ?>
...
" name="save_form" enctype="multipart/form-data">
	<div class="edit-form n150">
		<div class="row header"><?php if ($this->_vars['data']['id']):  echo l('admin_common_album_edit', 'media', '', 'text', array());  else:  echo l('admin_common_album_add', 'media', '', 'text', array());  endif; ?></div>
		<div class="row">
			<div class="h"><?php echo l('field_name', 'media', '', 'text', array()); ?>: </div>
			<div class="v">
...
<br>
		...
		<div class="row">
			<div class="h"><?php echo l('field_description', 'media', '', 'text', array()); ?>: </div>
			<div class="v"><textarea name="description" class="long"><?php echo $this->_vars['data']['description']; ?>
</textarea></div>
		</div>
	</div>
	<div class="btn"><div class="l"><input type="submit" name="btn_save" value="<?php echo l('btn_save', 'start', '', 'button', array()); ?>"></div></div>
	<a class="cancel" href="<?php echo $this->_vars['site_url']; ?>
admin/media/common_albums/"><?php echo l('btn_cancel', 'start', '', 'text', array()); ?></a>
</form>
<div class="clr"></div>
<script><?php echo '
	$(function(){
