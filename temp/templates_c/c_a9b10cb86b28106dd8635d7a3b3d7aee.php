...
<script><?php echo '
	var geomap_js_loaded = \'';  echo $this->_vars['geomap_js_loaded'];  echo '\';
	var only_load_content = \'';  echo $this->_vars['only_load_content'];  echo '\';
		...
		$(function() {	
			loadScripts(
				[
					...
					"https://maps.google.com/maps/api/js?v=3.8&libraries=places&sensor=true&key=';  echo $this->_vars['map_reg_key'];  echo '&callback=map_loader"
				],
				function(){},
