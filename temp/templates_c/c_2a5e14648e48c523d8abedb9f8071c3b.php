...
$this->register_compiler("l", "tpl_compiler_l");  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2015-08-31 17:35:15 Pacific Daylight Time */ ?>
...
" name="save_form" enctype="multipart/form-data">
	<div class="edit-form n150">
		<div class="row header">
			<?php if ($this->_vars['data']['id']): ?>
				<?php echo l('admin_header_city_change', 'countries', '', 'text', array()); ?>
			<?php else: ?>
				<?php echo l('admin_header_city_add', 'countries', '', 'text', array()); ?>
			<?php endif; ?>
		</div>
		<div class="row">
 ...
 (<?php echo $this->_vars['country']['code']; ?>
		...
		<div class="row">
			<div class="h"><?php echo l('field_region', 'countries', '', 'text', array()); ?>: </div>
			<div class="v"><?php echo $this->_vars['region']['name']; ?>
</div>
		</div>
		<div class="row">
			<div class="h"><?php echo l('field_city_name', 'countries', '', 'text', array()); ?>: </div>
			<div class="v">
...
<br>
		...
		<div class="row">
			<div class="h"><?php echo l('field_latitude_name', 'countries', '', 'text', array()); ?>: </div>
			<div class="v"><input type="text" value="<?php echo $this->_vars['data']['latitude']; ?>
" name="latitude"></div>
		</div>
		<div class="row">
			<div class="h"><?php echo l('field_longitude_name', 'countries', '', 'text', array()); ?>: </div>
			<div class="v"><input type="text" value="<?php echo $this->_vars['data']['longitude']; ?>
" name="longitude"></div>
		</div>
	</div>
	<div class="btn">
