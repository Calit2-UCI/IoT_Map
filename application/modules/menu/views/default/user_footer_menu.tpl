<div> <a href="http://uci.edu/" target="_blank"> <img src="https://communications.uci.edu/img/graphic-identity/seal/seal-blue.png" alt="UCI Seal LOGO" !--style="width:165px;height:63px;"-- align="right" style="border:1px"> </a> </div>
