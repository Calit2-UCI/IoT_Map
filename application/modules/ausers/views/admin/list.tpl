...
<div class="menu-level3">
	<ul>
		{block name='count_ausers' module='moderators'}
...
<tr{if $counter is div by 2} class="zebra"{/if}>
	...
	<td class="icons">
		{if $item.status}
		<a href="{$site_root}admin/{$item.module}/activate/{$item.id}/0"><img src="{$site_root}{$img_folder}icon-full.png" width="16" height="16" border="0" alt="{l i='link_deactivate_user' gid='ausers'}" title="{l i='link_deactivate_user' gid='ausers'}"></a>
		{else}
		<a href="{$site_root}admin/{$item.module}/activate/{$item.id}/1"><img src="{$site_root}{$img_folder}icon-empty.png" width="16" height="16" border="0" alt="{l i='link_activate_user' gid='ausers'}" title="{l i='link_activate_user' gid='ausers'}"></a>
		{/if}
		<a href="{$site_root}admin/{$item.module}/edit/{$item.id}"><img src="{$site_root}{$img_folder}icon-edit.png" width="16" height="16" border="0" alt="{l i='link_edit_user' gid='ausers'}" title="{l i='link_edit_user' gid='ausers'}"></a>
		<a href="{$site_root}admin/{$item.module}/delete/{$item.id}" onclick="javascript: if(!confirm('{l i='note_delete_user' gid='ausers' type='js'}')) return false;"><img src="{$site_root}{$img_folder}icon-delete.png" width="16" height="16" border="0" alt="{l i='link_delete_user' gid='ausers'}" title="{l i='link_delete_user' gid='ausers'}"></a>
	</td>
</tr>
{foreachelse}
<tr>
	<td class="center" colspan="5">{l i='ausers_list_empty' gid='ausers'}</td>
</tr>
{/foreach}
</table>
